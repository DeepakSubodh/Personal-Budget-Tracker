                  ...
                  <table class="table table-borderless table-striped table-earning">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <a class="btn btn-info" href="manage_category.php?id=<?php echo $row['id'];?>">Edit</a>&nbsp;
                              <a class="btn btn-danger" href="javascript:void(0)" onclick="delete_confir('<?php echo $row['id'];?>','category.php')">Delete</a>
                           </td>
                        </tr>
                        <?php } ?>
                     </tbody>

   ...
   <div class="section__content section__content--p30">
      <div class="container-fluid">
         <div class="row">
            <div class="col-lg-12">
               <h2>Expense</h2>
               <a href="manage_expense.php" class="btn btn-success">Add Expense</a>
               <br/><br/>
                  ...
                  <table class="table table-borderless table-striped table-earning">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <a class="btn btn-info" href="manage_expense.php?id=<?php echo $row['id'];?>">Edit</a>&nbsp;
                              <a class="btn btn-danger" href="javascript:void(0)" onclick="delete_confir('<?php echo $row['id'];?>','expense.php')">Delete</a>
                           </td>
                        </tr>
                        <?php } ?>
                     </tbody>
